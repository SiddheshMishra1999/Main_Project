...
<html>
  ...
  <body>
    ...
    <form action="Edit_person.php" method="post">
      <div class="form">
        <h1>Edit person</h1>
        <p>Please fill the desired information to edit a person that already exist in the database.</p>
        <hr>
      ...
      <input type="email" name="email" id="email" placeholeder="example@example.com"><br><br>
